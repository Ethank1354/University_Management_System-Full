...
public class AdminViewController {
    ...
    @FXML
    private TableView<engg1420_project.universitymanagementsystem.Subjects> subjectsTable;
    @FXML
    private TableColumn<Subjects, String> nameColumn;
    @FXML
    private TableColumn<Subjects, String> codeColumn;

    private ObservableList<engg1420_project.universitymanagementsystem.Subjects> subjectsData = FXCollections.observableArrayList();
